...
const _2026_02_report_json_1 = __importDefault(require("../src/data/2026-02-report.json"));
/**
...
async function addMonthlyReport() {
    ...
    try {
        ...
        const reportRawData = _2026_02_report_json_1.default;
        const newReport = {
            id: '2026-02',
            year: 2026,
            month: 2,
        ...
        if (docSnap.exists()) {
            ...
            if (data.monthly_reports && Array.isArray(data.monthly_reports)) {
                const reports = data.monthly_reports;
        ...
        await (0, firestore_1.updateDoc)(projectDataDocRef, {
            monthly_reports: (0, firestore_1.arrayUnion)(newReport)
